      ...
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 items-center mb-12 sm:mb-16">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
              {values.map((value, index) => (
                <Card 
                  key={index} 
                  className="p-4 sm:p-6 text-center hover:shadow-medium transition-all duration-300 hover:scale-105 bg-card-gradient"
                >
          ...
          <div className="grid md:grid-cols-2 gap-6 sm:gap-8">
            <Card className="p-6 sm:p-8 bg-card-gradient hover:shadow-medium transition-all duration-300">
              <h3 className="text-xl sm:text-2xl font-bold text-foreground mb-4 flex items-center">
                <Target className="h-5 w-6 text-primary mr-3" />
                Our Mission
              </h3>
            ...
            <Card className="p-6 sm:p-8 bg-card-gradient hover:shadow-medium transition-all duration-300">
              <h3 className="text-xl sm:text-2xl font-bold text-foreground mb-4 flex items-center">
                <Eye className="h-5 w-6 text-accent mr-3" />
                Our Vision
              </h3>
              <p className="text-muted-foreground leading-relaxed text-sm sm:text-base">
