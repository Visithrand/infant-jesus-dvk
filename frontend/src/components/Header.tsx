...
const Header = () => {
  ...
  const navItems = [
    ...
    { name: "Announcements", href: "/#announcements", type: "hash" },
    { name: "Admissions", href: "/#admissions", type: "hash" },
    { name: "Facilities", href: "/#facilities", type: "hash" },
    ...
    <>
      ...
      <div className="bg-gradient-to-r from-blue-900 via-blue-800 to-purple-900 text-white py-2 md:py-3 px-4 relative overflow-hidden">
        ...
        <div className="container mx-auto flex flex-col sm:flex-row items-center justify-between text-xs md:text-sm relative z-10 space-y-2 sm:space-y-0">
          <div className="flex flex-col sm:flex-row items-center space-y-1 sm:space-y-0 sm:space-x-2 md:space-x-6">
            ...
            <div className="flex items-center space-x-2 hover:text-blue-200 transition-colors">
              ...
              <span className="font-medium hidden sm:inline">info@infantjesusschool.ac.in</span>
              <span className="font-medium sm:hidden">info@infantjesusschool.ac.in</span>
            </div>
          </div>
          <div className="flex items-center space-x-2 md:space-x-4">
            ...
            <div className="flex items-center bg-white/20 px-2 md:px-3 py-1 rounded-full">
      ...
      <header className={cn(
        ...
        <div className="container mx-auto px-4 py-3 md:py-4">
            ...
            <div className="flex items-center space-x-2 md:space-x-4">
              <div className="relative">
                <img 
                  ...
                  className="h-8 w-8 sm:h-10 sm:w-10 md:h-14 md:w-14 object-contain shadow-lg rounded-lg"
                />
                <div className="absolute -bottom-1 -right-1 h-3 w-3 sm:h-4 sm:w-4 md:h-6 md:w-6 bg-green-500 rounded-full border-2 border-white flex items-center justify-center">
                  <div className="h-1 w-1 sm:h-2 sm:w-2 md:h-2 md:w-2 bg-white rounded-full"></div>
                </div>
              </div>
              <div className="block">
                <h1 className="text-xs sm:text-sm md:text-lg lg:text-xl font-bold text-gray-900 leading-tight">
                  INFANT JESUS MATRIC
                  <br />
            ...
            <nav className="hidden lg:flex items-center space-x-1">
              {navItems.map((item) => (
                <Link
                  ...
                  className="px-3 md:px-4 py-2 text-gray-700 hover:text-blue-600 hover:bg-blue-50 rounded-lg transition-all duration-300 font-medium relative group text-sm md:text-base"
                >
                  {item.name}
              ...
              <div className="ml-4">
                <Button 
                  ...
                  className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white font-semibold px-3 md:px-6 py-2 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 text-xs md:text-sm"
                >
          ...
          <div
            className={cn(
              "lg:hidden mt-4 space-y-2 transition-all duration-300 overflow-y-auto",
          ...
          >
            {navItems.map((item) => (
              <Link
                ...
                className="block text-gray-700 hover:text-blue-600 hover:bg-blue-50 rounded-lg px-4 py-3 transition-all duration-300 font-medium text-sm md:text-base"
              >
                {item.name}
              </Link>
            ))}
            <div className="pt-2 pb-4">
              <Button 
                variant="default" 
                size="sm" 
                className="w-full bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white font-semibold px-6 py-3 rounded-lg shadow-lg text-sm md:text-base" 
                onClick={handleDownloadForm}
              >
